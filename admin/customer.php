    ...
    if (isset($_POST["submit"])) {
        ...
        */
        ...
        if (!$customer_exists) {
            ...
            $sql = "INSERT INTO `customers` (`customer_name`, `customer_phone`,`customer_email`,`customer_password`, `customer_created`) VALUES ('$cname', '$cphone','$email','$cpassword', current_timestamp());";
...
<?php } else { ?>
    ...
    <section id="customer">
        ...
        <div id="customer-results">
            <div>
                <button id="add-button" class="button btn-sm" type="button" data-bs-toggle="modal"
                        data-bs-target="#addModal">Add Customer Details <i class="fas fa-plus"></i></button>
            </div>

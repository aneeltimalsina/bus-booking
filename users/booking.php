...
<?php //include '../assets/partials/_admin-check.php'; ?>
    ...
    */
    ...
    ?>
    <?php
    $customer_user_id = !empty($_SESSION['customer_user_id']) ? $customer_id = $_SESSION['customer_user_id'] : '';
    $customer_user_name = !empty($_SESSION['customer_user_name']) ? $customer_user_name = $_SESSION['customer_user_name'] : '';
    $customer_user_phone = !empty($_SESSION['customer_user_phone']) ? $customer_user_phone = $_SESSION['customer_user_phone'] : '';
            ...
            <div id="noCustomers" class="alert alert-dark " role="alert">
                ...
                <div id="addCustomerAlert" class="alert alert-success" role="alert">
                    ...
                    <button id="add-button" class="button btn-sm" type="button" data-bs-toggle="modal"
                            data-bs-target="#addModal">ADD <i class="fas fa-plus"></i></button>
                    to add a booking!
                </div>
            </div>
        </div>
...
<!--                            </td>-->
                            ...
                            <td>
<!--                                <button class="button btn-sm edit-button"-->
<!--                                        data-link="--><?php //echo $_SERVER['REQUEST_URI']; ?><!--"-->
<!--                                        data-customerid="--><?php
//                                        echo $customer_id; ?><!--" data-id="--><?php
//                                echo $id; ?><!--" data-name="--><?php
//                                echo $customer_name; ?><!--" data-phone="--><?php
//                                echo $customer_phone; ?><!--">Edit-->
<!--                                </button>-->
                                <button class="button delete-button btn-sm" data-bs-toggle="modal"
                ...
                <div class="modal-body">
                    <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="searchQuery">
                                <input type="text" class="form-control searchInput" id="cid" name="cid"
                                       value="<?= $customer_user_id ?>" readonly>
                                <div class="sugg">
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cname" name="cname"   value="<?= $customer_user_name?>" readonly>
                        </div>
                        <div class="mb-3">
                            <label for="cphone" class="form-label">Contact Number</label>
                            <input type="tel" class="form-control" id="cphone" name="cphone"   value="<?= $customer_user_phone ?>" readonly>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <!-- Search Functionality -->
                            <div class="searchQuery">
                                <input type="text" class="form-control searchInput" id="sourceSearch"
                                       name="sourceSearch">
                                <div class="sugg">
                                </div>
                            </div>

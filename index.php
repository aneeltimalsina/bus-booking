        ...
        <div class="alert alert-dark alert-dismissible fade show" role="alert">
            ...
            <p>
                ...
                <button class="btn btn-danger btn-sm" id="deleteBooking" data-bs-toggle="modal"
                        data-bs-target="#deleteModal" data-pnr="<?php echo $pnr; ?>"
                        data-seat="<?php echo $booked_seat; ?>" data-bus="<?php echo $bus_no; ?>">
                    Delete
                </button>
            </p>
            <hr>
...
<section id="home">
    <div id="route-search-form">
        ...
        <p class="text-center">Welcome to Online Bus Ticket Booking System. Login now to manage bus tickets and much
            more. OR, simply scroll down to check the Ticket status using Passenger Name Record (PNR number)</p>

        <center>
            <a href="/users/passenger-signup.php" class="btn btn-danger">Passenger SignUp</a>
            <a href="/users/passenger-login.php" class="btn btn-danger">Passenger SignIn</a>
        </center>

        <br>
        <center>
            <a href="#pnr-enquiry">
                <button class="btn btn-primary">Scroll Down <i class="fa fa-arrow-down"></i></button>
            </a>
        </center>
...
<div id="block">
    ...
    <section id="about">
        <div>
            ...
            <p>
                online bus ticketing system is a internet based system. It provides ticket easier and short time to help
                customer. online bus ticketing system typically includes a user-friendly interface that allows
                passengers to search for available buses, view bus schedules, select their preferred seats, and make
                secure payments using various payment methods. The system also enables passengers to cancel or modify
                their bookings, and receive e-tickets
            </p>
        </div>
    </section>
    <section id="contact">
        <div id="contact-form">
            <h1>Contact Us</h1>
            <form action="/assets/partials/feedback.php" method="post">
                <div>
                ...
                <div>
                    ...
                    <textarea name="feedback" id="message" cols="30" rows="10"></textarea>
                </div>
                <div>
    ...
    <footer>
        <p>
            <i class="far fa-copyright"></i> <?php echo date('Y'); ?> Online Bus Ticket Booking System
        </p>
    </footer>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" form="delete-form" class="btn btn-primary btn-danger" name="deleteBtn">Delete
                </button>
            </div>
        </div>
    </div>
